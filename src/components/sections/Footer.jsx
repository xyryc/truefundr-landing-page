import companyBrandLogo from "/companyBrandLogo.png";
...
const Footer = () => {
  ...
  return (
    <section className="py-10 bg-[#020617] sm:pt-16 lg:pt-24" ref={ref}>
      <motion.div
      ...
      >
        <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
          ...
          <div>
            <p className="text-base text-gray-500">Help Center</p>
        ...
        <div className="flex flex-wrap items-center justify-between">
          <img
            className="h-8 auto md:order-1 invert brightness-0"
          ...
          <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">
            © Copyright 2025, All Rights Reserved by TrueFundr
          </p>
        </div>
      </motion.div>
    </section>
